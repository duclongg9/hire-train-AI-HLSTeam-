...
1. Hard Constraint (Kinh nghiệm thực tế) - Tối đa 30 điểm:
   - Nếu CV hoàn toàn không có kinh nghiệm hoặc 0 năm kinh nghiệm phù hợp: KHÔNG ĐƯỢC QUÁ 5 ĐIỂM cho mục này.
   - Có đủ số năm kinh nghiệm theo yêu cầu: 20 - 30 điểm.

2. Keyword & Semantic Matching (Kỹ năng) - Tối đa 40 điểm:
   - Đánh giá mức độ khớp kỹ năng chuyên môn giữa CV và JD.
   - Mỗi kỹ năng xuất hiện có minh chứng công việc cụ thể: +10 điểm/kỹ năng.
