...
import { CriteriaScoringScreen } from "@/components/recruitment/cv-rubric-screen"
import { TestReviewScreen } from "@/components/recruitment/hr-screens"
import { InterviewRubricEditorPage } from "@/components/recruitment/interview-rubric-editor"
...
export default function PositionAIPipelinePage() {
  ...
  return (
    <HrShell 
      ...
      subtitle="Complete the 3-step configuration for this position."
    >
