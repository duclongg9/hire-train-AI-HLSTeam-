...
import { AdminShell } from "@/components/recruitment/app-shell"
import { EmptyState, FormMessage, StatusPill, StatCard } from "@/components/recruitment/common"
...
import { createAdminUser, listAdminUsers, listAuditLogs, type BackendAuditLog, type BackendUser } from "@/lib/recruitment/api"
...
export function AdminUsersScreen() {
  ...
  return (
    <AdminShell title="HR Account Provisioning" subtitle="Create and control HR manager accounts from the admin console.">
...
export function AdminLogsScreen() {
  ...
  return (
    <AdminShell title="System Logs" subtitle="Review account, publishing, and security events.">
      <Card className="rounded-lg p-4 shadow-sm">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
