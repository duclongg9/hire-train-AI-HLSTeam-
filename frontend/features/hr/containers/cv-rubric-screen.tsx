...
import { formatApiError, getRubric, publishCampaign, saveRubric, type BackendRubricCriterion } from "@/features/hr/api/hr-api"
...
export function CriteriaScoringScreen() {
  ...
  return (
    <>
      <PageHeader title="CV Rubric Criteria Scoring" subtitle="Create, edit, organize, and AI-generate scoring criteria for CV evaluation." />
